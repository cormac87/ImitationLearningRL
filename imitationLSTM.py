...
with open("bp", "rb") as fp:   # Unpickling
    ballPosList = pickle.load(fp)

with open("bv", "rb") as fp:   # Unpickling
    ballVelList = pickle.load(fp)

with open("p1p", "rb") as fp:   # Unpickling
    player1PosList = pickle.load(fp)
    
with open("p1v", "rb") as fp:   # Unpickling
    player1VelList = pickle.load(fp)
    
with open("p2p", "rb") as fp:   # Unpickling
    player2PosList = pickle.load(fp)
    
with open("p2v", "rb") as fp:   # Unpickling
    player2VelList = pickle.load(fp)
bpL = []
